...
namespace Cnblogs.XamarinAndroid
{
    ...
    public  class QuestionEditAnswerCommentActivity : BaseActivity
    {
        ...
        internal static void Enter(Context context,int questionId, int answerId,int commentId,string content)
        {
            Intent intent = new Intent(context, typeof(QuestionEditAnswerCommentActivity));
